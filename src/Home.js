...
const Home=()=>{
    ...
    const socialmedia=[
        ...
        {link:"https://www.linkedin.com/in/aakesh44/",icon:<AiOutlineLinkedin className="text-amber-400 hover:scale-105 drop-shadow cursor-pointer xl:h-8 xl:w-8 lg:h-7 lg:w-7 md:h-6 md:w-6 h-6 w-6"/>},
        {link:"https://www.instagram.com/aakesh_rex/",icon:<AiOutlineInstagram className="text-amber-400 hover:scale-105 drop-shadow cursor-pointer xl:h-8 xl:w-8 lg:h-7 lg:w-7 md:h-6 md:w-6 h-6 w-6"/>},
        {link:"https://github.com/Aakesh44",icon:<AiOutlineGithub className="text-amber-400 hover:scale-105 drop-shadow cursor-pointer xl:h-8 xl:w-8 lg:h-7 lg:w-7 md:h-6 md:w-6 h-6 w-6"/>},
        {link:"mailto:aakeshviswanathan@gmail.com",icon:<AiOutlineMail className="text-amber-400 hover:scale-105 drop-shadow cursor-pointer xl:h-8 xl:w-8 lg:h-7 lg:w-7 md:h-6 md:w-6 h-6 w-6"/>},
    ...
    return(
        <main className="h-screen   w-full  flex flex-col items-center" >
            ...
            <div   className="Mainbg my-auto   w-full h-5/6  flex flex-col md:flex-row justify-center items-center px-12 md:px-20 xl:px-44 py-20">

                <div className=" bg-a mber-400 h-3/5 w-full md:w-1/2 md:h-3/5 xl:h-4/5 flex items-center justify-center" data-aos="fade-up">
                ...
                <div className=" bg-gr een-400 h-2/5 w-full md:w-1/2 md:h-3/5 lg:h-4/5 md:py-14 lg:py-20  flex flex-col  items-center " data-aos="fade-up">
            ...
            <div  className="Mainbg mt-auto  w-full flex flex-col  justify-center h-1/6 ">
